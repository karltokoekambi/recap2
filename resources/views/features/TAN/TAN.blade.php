                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Début</th>
                        ...
                        @foreach($datas as $data)
                            @if($data->abonnement_TAN == 1 || $data->abonnement_TAN == 2)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $data->prénom }}</td>
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr>
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Nom</th>
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Prenom</th>
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Carte Mcbooster donnée le</th>
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Papier signé</th>
                        </tr>
                        </thead>
                        <tbody class="bg-white">
                        @foreach($datas as $data)
                            @if($data->date_don_carte_McBooster)
                                <tr>
                                    ...
                                    @if($data->papier_McBooster_signé)
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 border-b border-gray-200 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" scope="col">Carte donnée le</th>
                        </tr>
                        </thead>
                        <tbody class="bg-white">
                        @foreach($datas as $data)
